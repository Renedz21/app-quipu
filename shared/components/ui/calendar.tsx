    ...
    <DayPicker
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }) => {
          if (orientation === "left") {
            return (
              <ChevronLeft size={16} color="currentColor" className={cn(className)} {...props} />
            )
          }

          if (orientation === "right") {
            return (
              <ChevronRight size={16} color="currentColor" className={cn(className)} {...props} />
            )
          }

          return (
            <ChevronDown size={16} color="currentColor" className={cn(className)} {...props} />
          )
        },
        DayButton: ({ ...props }) => (
